...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if let window = window {
            ...
            navigationController.navigationBar.barTintColor = UIColor(red: 58/255, green: 62/255, blue: 63/255, alpha: 1)
            navigationController.navigationBar.layer.shadowColor = UIColor.blackColor().CGColor
            navigationController.navigationBar.layer.shadowOpacity = 1
            navigationController.navigationBar.layer.shadowOffset = CGSizeZero
